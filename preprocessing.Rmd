...
```
cytoMine (--inputFiles=<files> --beadMasses=<beads> --outputDir=<results_dir>) [--k=<k> --trim=<trim> --removeBeads=<rmbeads>]
...
```
cytoMine  --inputFiles=test.fcs --beadMasses=140,151,153,165,175 --outputDir=results --k=300
```
